...
if __name__ == '__main__':
    ...
    ### training options
    parser.add_argument('--iters', type=int, default=3000, help="training iters")
    parser.add_argument('--lr', type=float, default=4e-2, help="initial learning rate")
    ...
    parser.add_argument('--eval_interval', default=5, help="eval_interval")
    ### dataset options
    ...
    ###### NeRFProtector
    parser.add_argument('--lambda1', type=float, default=0.001, help="Weight of watermarking loss")
    parser.add_argument('--local_sample', default=True, help="Ordinary NeRF sampling (local)")
    parser.add_argument('--global_sample', default=False, type=bool, help="single-layer view sampling (global)")
    parser.add_argument('--ml_sample', default=False, type=bool, help="multi-layer views sampling")

    parser.add_argument('--random_pose', default=False, type=int, help="Sample one random view")
    parser.add_argument('--extractor', default='dec_48b_whit.torchscript.pt', type=str, help="extractor")
    parser.add_argument('--bit', default=48, type=int, help="extractor")
    ...
    if opt.test:
        ...
        metrics = [PSNRMeter(), SSIMMeter(), LPIPSMeter(device=device), BitAccMeter(device=device)]
